...
//	$show_thumb = get_option ('show_thumb');
	...
	if (isset ( $_POST ['Submit'] )) {
        ...
        $accept_donations = $_REQUEST ['accpet_donations'];
...
" SET organization='$org_name',
 ...
 accept_donations = '$accpet_donations',
...
<div class="box-mid-body" id="toggle2">
   ...
   <ul><?php
    ...
    echo "<li>Will you accept donations for free events: <select name = 'accpet_donations'>";
