...
<?php
    ...
    switch ($er_categories_action) {
        ...
        case "add":
                ...
                'font_color'=>$category_font, 'category_color'=>$category_background); 
