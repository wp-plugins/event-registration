...
/*------------------POPUPS------------------------*/
	...
	while ($row = mysql_fetch_assoc ($result)){
            ...
            <a  href="#TB_inline?height=600&width=400&inlineId=popup<?php echo $item_id;?>" class="thickbox"><img src="<?php echo EVR_PLUGINFULLURL;?>images/small_gear.png" alt="Edit" /></td>
