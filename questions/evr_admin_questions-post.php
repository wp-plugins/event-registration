...
function evr_post_question(){
		...
		//	$wpdb->query ( "INSERT INTO ".get_option('evr_question')." (`event_id`, `sequence`, `question_type`, `question`, `response`, `required`)" . " values('$event_id', '$sequence', '$question_type', '$question', '$values', '$required')" );
			if ($wpdb->query ( "INSERT INTO ".get_option('evr_question')." (`event_id`, `sequence`, `question_type`, `question`, `response`, `required`)" . " values('$event_id', '$sequence', '$question_type', '$question', '$values', '$required')" )
			){ ?>
