...
function event_regis_pay() {
	...
	if ($id == "") {echo "Please check your email for payment information.";} 
		...
		if ($amt_pd != "") {echo "<p><b><u><i><font color='red' size='3'>Our records indicate you have paid " . $paypal_cur . " " . $amt_pd . "</font></u></i></b></p>";}
		if ($event_cost != "") {
			...
			if ($paypal_id != "") {
				...
				<p>Payment will be in the amount of 
				<?php 
				
				$total_cost = $event_cost * $num_people;
				$current_due = $total_cost - $amt_pd;
				echo $paypal_cur . " " . $current_due." </p>";
				?>
				
				<p align="left">PayPal Payments will be sent to: 
				
				<?php 
				echo $Organization . " (" . $paypal_id." )</p>";
				if ($paypal_cur == "$" || $paypal_cur == "") {$paypal_cur = "USD";}
				?>
				...
				<table width="500">
					<tr>
						...
						<input type="hidden" name="item_name" value="<?php echo $event_name . " - " . $attendee_id . " - " . $attendee_name . $payment;?>" style="font-weight: 700"> 
						<input type="hidden" name="item_number"	value="<?php echo $event_identifier;?>" style="font-weight: 700"> 
						<input type="hidden" name="amount" value="<?php	echo $current_due;?>" style="font-weight: 700"> 
						...
						<input type="hidden" name="image_url" style="font-weight: 700"> </font><b><font face="Arial" size="2">&nbsp;<br />
...
?>
		...
		<?php echo $event_name . " - " . $attendee_id . " - " . $attendee_name." - ";
