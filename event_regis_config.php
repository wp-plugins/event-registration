...
$events_attendee_tbl_version = "4.0";
$events_detail_tbl_version = "4.0";
$events_organization_tbl_version = "4.0";
$events_answer_tbl_version = "4.0";
$events_question_tbl_version = "4.0";
